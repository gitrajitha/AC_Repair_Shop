...
<div class="row"><!-- 1 row Starts -->
    ...
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        ...
        <h1 class="page-header">Manage Supplier debits</h1>

        <ol class="breadcrumb"><!-- breadcrumb Starts -->

            <li class="active">

                <i class="fa fa-industry"></i>  View Supplier Debits
        ...
        <div class="panel panel-primary" ><!-- panel panel-primary Starts -->
            ...
            <div class="panel-heading" ><!-- panel-heading Starts -->
                ...
                <h3 class="panel-title" ><!-- panel-title Starts -->
                    ...
                    <i class="fa fa-money fa-fw" ></i>Supplier's Details
    ...
    <div class="modal-dialog modal-lg" style="width: 90%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="panel-body"><!--panel-body starts-->
                    <button class="tablink" onclick="openPage('About', this, 'gray')">Debit Grn Details</button>
                    ...
                    <div id="News" class="tabcontent">
                        <div class='row'>
                            <div class='col-md-12'>
                                <div class="ui-widget">
                                    <div class="col-md-4">
                                        <label for="totcredit">Total Debit Amount: </label><br>
...
// Get the element with id="defaultOpen" and click on it
    ...
    $(document).on('click', '.btn_view', function() {
        ...
        $.ajax({
            url: "managedebits_getmodalcontent.php",
            method: "POST",
            data: {id: id},
            dataType: "text",
            success: function(data) {
    ...
    function getnetamount(id) {
        ...
        $.ajax({
            url: "managedebits_getnetamount.php",
            method: "POST",
            data: {id: id},
            dataType: "json",
            success: function(data) {
     ...
     function getpayementhistory(id) {
        ...
        $.ajax({
            url: "managedebits_getpaymenthistory.php",
            method: "POST",
            data: {id: id},
            dataType: "text",
            success: function(data) {
